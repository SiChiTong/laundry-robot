...
static float transformVelocity (float thetaCurrent, float thetaDesired) {
  ...
  float l = 5; // distance between x,y tilde and x,y
  ...
  if (omega > 1) omega = 0.5;
  else if (omega < -1) omega = -0.5;
